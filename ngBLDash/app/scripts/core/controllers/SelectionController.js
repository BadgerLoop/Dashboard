angular
	.module('theme.core.selection_controller', ['ngTouch', 'ui.grid', 'ui.grid.selection']);
 
app.controller('SelectionController', ['$scope', '$http', '$log', '$timeout', 'uiGridConstants', function ($scope, $http, $log, $timeout, uiGridConstants) {
  $scope.gridOptions = {
