angular.module('theme.core.dashboard', ['theme.core.services'])
  .controller('DashboardController', ['$scope', '$theme', '$timeout', '$window','pinesNotifications', 'BatteryService', function($scope, $theme, $timeout, $window, pinesNotifications, BatteryService) {
    'use strict';
