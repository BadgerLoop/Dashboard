...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-BLDashboard/CocoaAsyncSocket.framework"
  install_framework "Pods-BLDashboard/GHODictionary.framework"
  install_framework "Pods-BLDashboard/JSKTimerView.framework"
